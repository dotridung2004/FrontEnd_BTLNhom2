...
class _DocumentDialogState extends State<DocumentDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      // ✅ SỬA LỖI: Bọc nội dung trong một GestureDetector riêng để xử lý việc tắt bàn phím
      // mà không ảnh hưởng đến các nút bấm.
      child: GestureDetector(
        onTap: () {
          // Khi nhấn vào vùng trống của dialog, gỡ bỏ focus khỏi TextField
